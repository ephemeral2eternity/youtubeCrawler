...
parser.add_argument('--locale', action='store', dest='location', help='get a video id list to get corresponding urls.')
inputs = parser.parse_args()

outFile = open(inputs.id_file + "_" + inputs.location + "_hosts.csv", 'w')
missIDFile = open(inputs.location + "_miss.ids", 'w')
